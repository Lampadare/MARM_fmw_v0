...
struct _isr_table_entry __sw_isr_table _sw_isr_table[48] = {
	...
	{(const void *)0x256e9, (ISR)0x315bb}, /* 35 */
	...
	{(const void *)0x25d51, (ISR)0x315bb}, /* 47 */
};
