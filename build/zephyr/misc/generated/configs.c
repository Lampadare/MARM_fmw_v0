...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DT_HAS_INTAN_RHD2232_ENABLED, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_PERIPHERAL_PREF_MIN_INT, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_PERIPHERAL_PREF_MAX_INT, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DISK_DRIVER_MMC, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_MMC_VOLUME_NAME, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_MMC_LOG_LEVEL_DEFAULT, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_MMC_LOG_LEVEL, 3);
